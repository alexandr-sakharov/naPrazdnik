...
const InfoExpand = () => {
    return (
        <section id="infoexpand" className="infoexpand">
            <div className="container">
                <h2>Место проведения <a href="#">в Санкт-Петербурге</a></h2>
                <div className="row">
                    <div className="col-xs-12 col-md-6">
                        <p className="sub">Мы тщательно подходим к выбору
                            компаний, поэтому
                            перед началом сотрудничества мы обязательно проводим тестирование качества
                            предоставления
                            услуг</p>
                    </div>
                    <div className="col-xs-12 col-md-6">
                        <p className="sub">При бронировании услуги по
                            сертификату вы сами
                            выбираете место проведения впечатления.</p>
                    </div>
                </div>
                <div className="expandblock active">
                    <div className="title"><span>Студия танца Big Dance (м. Театральная)</span>
                        <button>
                            <span>Скрыть</span>
